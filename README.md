...
**NB!** Live demoen er på Render sin gratis tier. Etter en periode med inaktivitet kan det ta opptil 60 sekunder før serveren er oppe igjen. Jeg har laget testbrukere under man kan logge på med. Med disse er det bare å opprette timer, slette timer, pasienter, behandlere, endre profilbilder og klinikker. **Logg inn og utforsk fritt** — timer og klinikker er forhåndsutfylt.
